...
import Navbarv from './component/Navbar/Navbarr'
import Crousell from './component/Crousel/Crousell'
...
function App() {
  ...
  <BrowserRouter>
    ...
    <Route
          path="/tour/:title"
          render={(props) =><> <Navbarv /> <TourDetails {...props} tours={tours} /> </>}
        />
    </BrowserRouter>
  );
}
